...
//    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
//        serviceScope.launch {
//            // Only start if we're actually in blocking time
//            if (shouldBeRunning()) {
//                val notification = buildNotification()
//                startForeground(NOTIFICATION_ID, notification)
...
//                startMonitoring()
//            } else {
//                Log.d("AppMonitoringService", "Service started but not in blocking time, stopping")
//                stopSelf()
//                return@launch
//            }
//        }
...
//
//
//    private suspend fun shouldBeRunning(): Boolean {
//        val blockingEnabled = preferencesManager.blockingEnabled.first()
...
//            if (!shouldBeRunning()) {
//                Log.d("AppMonitoringService", "Outside blocking hours, stopping service")
//                preferencesManager.setBlockingEnabled(false)
//                stopSelf()
//                return
//            }
...
//            if (blockedApps.isEmpty()) return
//
//            // Capture the current foreground app BEFORE anything
//            val currentApp = getCurrentForegroundApp()
//            lastDetectedApp = currentApp
//            Log.d("blockerdebugams", "Foreground app detected: $currentApp")
//            delay(100)
//
//            // Only block AFTER verifying
//            if (currentApp != null && blockedApps.contains(currentApp)) {
//                if (isInBlockingHours()) {
//                    blockApp(currentApp)
//                }
